...
Nationality options:
- "iranian": for Iranian citizens
- "non_iranian": for non-Iranian citizens  
- "diplomat": for diplomatic passport holders

If any field is missing, use an empty string or 0. For nationality, default to "iranian" if not specified. Only return the JSON object, nothing else.
